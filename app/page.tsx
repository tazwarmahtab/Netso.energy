    ...
    <main className="min-h-screen text-white">
      ...
      <section className="relative z-10 py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">Solar Savings Calculator</h2>
          <p className="text-slate-400 mb-8">Enter your monthly electricity bill to estimate system size, generation, and net metering savings.</p>
          <SolarCalculator />
        </div>
      </section>
